...
const HEADER_LINKS = [
  {
    key: "Projects",
    component: () => (
      <UI.NavLink href="https://projects.umaproject.org/">Projects</UI.NavLink>
    ),
  },
  {
    key: "Products",
    component: ({ path }: { path: string }) => (
      <UI.NavLink href="/products" active={path === "/products"}>
        Products
      </UI.NavLink>
    ),
  },
...
const MOBILE_HEADER_LINKS: IHeaderLink[] = [
  {
    key: "Projects",
    component: () => (
      <UI.MobileNavLink href="https://projects.umaproject.org/">
        Projects
      </UI.MobileNavLink>
    ),
  },
